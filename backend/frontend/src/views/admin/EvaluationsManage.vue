        ...
        <el-row style="padding: 10px;margin: 0 10px;">
            <el-row>
                <el-date-picker size="small" style="width: 220px;" v-model="searchTime" type="daterange"
                    range-separator="至" start-placeholder="Comments begin" end-placeholder="Comments end">
                </el-date-picker>
                <el-input size="small" style="width: 188px;margin-left: 5px;margin-right: 6px;"
                    v-model="evalustionsQueryDto.content" placeholder="Comments content" clearable @clear="handleFilterClear">
                ...
                <el-table-column prop="parentId" width="120" label="level">
                    <template slot-scope="scope">
                        ...
                        <span v-if="scope.row.parentId === null"
                            style="text-decoration: underline;text-decoration-style: dashed;">parent-level</span>
        ...
        <el-dialog title="" :show-close="false" :visible.sync="reportDialog" width="35%">
            ...
            <span slot="footer" class="dialog-footer">
                <el-button class="customer" size="small" style="background-color: rgb(241, 241, 241);border: none;"
                    @click="reportDialog = false">Cancel</el-button>
            </span>
        </el-dialog>
    </el-row>
</template>
