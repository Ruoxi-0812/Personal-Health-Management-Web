        ...
        <el-row>
            ...
            <el-col :span="16">
                <div style="padding: 15px;box-sizing: border-box;">
                    <LineChart height="290px" tag="Total Users" @on-selected="userDatesSelected" :values="userValues"
                        :date="userDates" />
                </div>
                <div style="padding: 15px;box-sizing: border-box;">
                    <LineChart height="290px" tag="Health Metrics" @on-selected="modelDatesSelected" :values="modelValues"
                        :date="modelDates" />
                </div>
            </el-col>
        </el-row>
